        ...
        <div class="media">
            ...
            <div class="media-body">
                ...
                <div class="media">
                    ...
                    <p>{{$album->description}}
                    <p>
                        <a href="{{route('add-photo',array('id'=>$album->id))}}">
                            <button type="button" class="btn btn-primary btn-large">Add New Image to Album</button>
                        </a>
                        <a href="{{route('delete-album',array('id'=>$album->id))}}"
            ...
            <div class="col-lg-3">
                <div class="thumbnail" style="max-height: 350px;min-height: 350px;">
                    ...
                    <div class="caption">
                        ...
                        <a href="{{route('delete-image',array('id'=>$photo->id))}}"
                           onclick="return confirm('Are you sure?')">
                            <button type="button" class="btnbtn-danger btn-small">Delete Image</button>
                        </a>
                    </div>
                </div>
            </div>
